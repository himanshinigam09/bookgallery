...
<head>
           ...
           <ul class="portfolio-sorting list-inline text-center" >
            ...
            <li><a href="#" data-group="M1">Mathematics-I</a></li>
            <li><a href="#" data-group="S1">Statistical Methods-I</a></li>
            <li><a href="#" data-group="phy1">Physics-I</a></li>
            <li><a href="#" data-group="C">C Programming</a></li>
            <li><a href="#" data-group="PC">PC Software</a></li>
          ...
          <li class="col-md-4 col-sm-4 col-xs-6" data-groups='["M1"]'>
            ...
            <li class="col-md-4 col-sm-4 col-xs-6" data-groups='["phy1 Sem"]'>
              <figure class="portfolio-item" id="hvr-grow-shadow">
            ...
            <li class="col-md-4 col-sm-4 col-xs-6" data-groups='["PC"]'>
                <figure class="portfolio-item" id="hvr-grow-shadow">
           ...
           <li class="col-md-4 col-sm-4 col-xs-6" data-groups='["C"]'>
            ...
            <li class="col-md-4 col-sm-4 col-xs-6" data-groups='["S1"]'>
              <figure class="portfolio-item" id="hvr-grow-shadow">
