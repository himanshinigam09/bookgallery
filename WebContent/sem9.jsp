...
<ul class="portfolio-sorting list-inline text-center">
          ...
          <ul class="portfolio-items list-unstyled" id="grid">
            ...
            <li class="col-md-4 col-sm-4 col-xs-6" data-groups='["AI"]'>
            ...
            <li class="col-md-4 col-sm-4 col-xs-6" data-groups='["CT"]'>
              <figure class="portfolio-item" id="hvr-grow-shadow">
             ...
             <li class="col-md-4 col-sm-4 col-xs-6" data-groups='["OOAD"]'>
              <figure class="portfolio-item" id="hvr-grow-shadow">
