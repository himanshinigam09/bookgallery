...
<ul class="portfolio-sorting list-inline text-center">
            ...
            <li><a href="#" data-group="CA">Computer Architecture</a></li>
            <li><a href="#" data-group="LS">Linear Systems</a></li>
          ...
          <ul class="portfolio-items list-unstyled" id="grid">
            ...
            <li class="col-md-4 col-sm-4 col-xs-6" data-groups='["CA"]'>
             ...
             <li class="col-md-4 col-sm-4 col-xs-6" data-groups='["OS"]'>
              <figure class="portfolio-item" id="hvr-grow-shadow">
            ...
            <li class="col-md-4 col-sm-4 col-xs-6" data-groups='["LS"]'>
              <figure class="portfolio-item" id="hvr-grow-shadow">
